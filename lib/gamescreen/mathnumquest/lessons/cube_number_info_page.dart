...
import 'package:supersetfirebase/gamescreen/mathnumquest/FlashCards/CubeNumberInfoPage.dart';
import '../analytics_engine.dart';

class CubeNumberInfoPage extends StatefulWidget{
  @override
   _CubeNumberInfoPageState createState() => _CubeNumberInfoPageState();
}
class _CubeNumberInfoPageState extends State<CubeNumberInfoPage> {
  final FlutterTts flutterTts = FlutterTts();
  List<dynamic> lessonData = [];
  final String lessonType = 'cube_numbers';

  Future<void> loadLessonData() async {
    final String jsonData =
        await rootBundle.loadString('assets/MathNumQuest/cubenum_lesson.json');
    setState(() {
