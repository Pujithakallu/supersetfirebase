...
class FibonacciNumberInfoPage extends StatefulWidget{
  @override
  _FibonacciNumberInfoPageState createState() => _FibonacciNumberInfoPageState();
}

class _FibonacciNumberInfoPageState  extends State<FibonacciNumberInfoPage> {
  final FlutterTts flutterTts = FlutterTts();
  List<dynamic> lessonData = [];
  final String lessonType = 'fibonacci_numbers';

  Future<void> loadLessonData() async {
    final String jsonData =
        await rootBundle.loadString('assets/MathNumQuest/fibonacci_lesson.json');
    setState(() {
