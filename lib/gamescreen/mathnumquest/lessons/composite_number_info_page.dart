...
import 'package:supersetfirebase/gamescreen/mathnumquest/FlashCards/CompositeNumberPracticePage.dart';
import '../analytics_engine.dart';


class CompositeNumberInfoPage extends StatefulWidget {
  @override
  _CompositeNumberInfoPageState createState() => _CompositeNumberInfoPageState();
}

class _CompositeNumberInfoPageState extends State<CompositeNumberInfoPage> {
  final FlutterTts flutterTts = FlutterTts();
  List<dynamic> lessonData = [];
  final String lessonType = 'composite_numbers';

  Future<void> loadLessonData() async {
    final String jsonData =
        await rootBundle.loadString('assets/MathNumQuest/composite_lesson.json');
    setState(() {
