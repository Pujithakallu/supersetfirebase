...
class TriangularNumberInfoPage extends StatefulWidget{
  @override
  _TriangularNumberInfoPageState createState() =>  _TriangularNumberInfoPageState(); 
}
class _TriangularNumberInfoPageState extends State<TriangularNumberInfoPage> {
  final FlutterTts flutterTts = FlutterTts();
  List<dynamic> lessonData = [];
  final String lessonType = 'triangular_numbers';

  Future<void> loadLessonData() async {
    final String jsonData =
        await rootBundle.loadString('assets/MathNumQuest/triangular_lesson.json');
    setState(() {
