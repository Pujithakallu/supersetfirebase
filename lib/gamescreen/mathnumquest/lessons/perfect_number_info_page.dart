...
import 'package:supersetfirebase/gamescreen/mathnumquest/FlashCards/PerfectNumbersPracticePage.dart';
import '../analytics_engine.dart';

class PerfectNumberInfoPage extends StatefulWidget {
  @override
   _PerfectNumberInfoPageState createState() => _PerfectNumberInfoPageState();
}
class _PerfectNumberInfoPageState extends State<PerfectNumberInfoPage> {
  final FlutterTts flutterTts = FlutterTts();
  List<dynamic> lessonData = [];
  final String lessonType = 'perfect_numbers';

  Future<void> loadLessonData() async {
    final String jsonData =
        await rootBundle.loadString('assets/MathNumQuest/perfectnum_lesson.json');
    setState(() {
