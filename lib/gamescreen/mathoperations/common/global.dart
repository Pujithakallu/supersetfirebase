...
class GlobalVariables {
  ...
  static void setUserData() {
    ...
    Map<dynamic, dynamic> data = {"name": "kjhsa"};

    priLang = data.containsKey("primary_lang")
        ? data["primary_lang"]!
        : "English"; // Private static variable
    secLang = data.containsKey("primary_lang")
        ? data["primary_lang"]!
        : "Spanish"; // Private static variable
    userName = data.containsKey("primary_lang")
        ? data["primary_lang"]!
        : "Guest"; // Private static variable
    userID = data.containsKey("primary_lang")
        ? data["primary_lang"]!
        : "999999"; // Private static variable
  }
