...
//           Positioned.fill(
//             child: Image.asset(
//               "assets/images/background.png", // Ensure this file exists in assets
//               fit: BoxFit.cover,
//             ),
//           ),
...
//                             onTap: () {
//                               // Navigate to respective game screen
//                             },
//                             child: Column(
//                               children: [
//                                 // Game Box with Background Image
//                                 Container(
//                                   width: 180,
//                                   height: 180,
...
//                                 // Progress (Set to 0% for all games)
//                                 Row(
//                                   mainAxisAlignment: MainAxisAlignment.center,
//                                   children: [
//                                     Text(
  ...
  final List<Map<String, dynamic>> games = [
    {
      ...
      'description': 'Fun with numbers!',
      'progress': 0,
      'route': MathMingleApp(), // Added Route to Navigate
    },
    {
      'title': 'Math Equations',
      'backgroundImage': 'assets/images/math_equations.png',
      ...
      'description': 'Master equations!',
      'progress': 0,
      'route': MyApp(), // Added Route to Navigate
    },
    {
      'title': 'Math Operators',
      'backgroundImage': 'assets/images/math_operators.png',
      ...
      'description': 'Learn new symbols & more!',
      'progress': 0,
      'route': Operators(), // Added Route to Navigate
    },
    {
      'title': 'Studio',
      'backgroundImage': 'assets/images/art_studio.png',
      ...
      'description': 'Draw and create!',
      'progress': 0,
      'route': null, // No route for this yet
    },
  ];
